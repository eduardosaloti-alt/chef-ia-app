...
function formatDateBR(dateStr: string) {
  // Formata "YYYY-MM-DD" direto, sem passar por Date (evita o fuso
  // horário UTC voltar a data em 1 dia em fusos negativos).
              ...
              <div key={p.id} className="flex items-center justify-between py-3">
                <div>
                  ...
                  <p className="text-xs text-cacau/50 dark:text-cream/50">
                    {cliente?.nome} · {formatDateBR(p.dataEntrega)}
                  </p>
                </div>
