    ...
    <div className="bg-cream dark:bg-cacau">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-24 text-center">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <Card>
            <Badge tone="pistache" className="mb-3">Plano anual · economize 45%</Badge>
            <p className="font-display text-4xl">
              R$ 197<span className="text-base text-cacau/50 dark:text-cream/50">/ano</span>
            </p>
            <p className="mt-2 text-sm text-cacau/60 dark:text-cream/60">
              Pague uma vez e use o Chef IA o ano inteiro, sai bem mais barato que o plano mensal.
            </p>
            <Link href="https://cheffia.site/">
              <Button className="mt-6 w-full">Quero o plano anual</Button>
            </Link>
          </Card>
        </div>
      </section>
